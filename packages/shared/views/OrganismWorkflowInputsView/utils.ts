...
/**
 * Projects a concrete organism entity onto the shared organism shape consumed by
 ...
 * absent on some organisms (priority, priority pathogen) resolve to undefined and
 * are not displayed.
 * @param organism - Concrete organism entity.
