...
class Outbreak(ConfiguredBaseModel):
    ...
    name: str = Field(default=..., description="""The name of the outbreak/ pathogen.""", json_schema_extra = { "linkml_meta": {'alias': 'name', 'domain_of': ['Outbreak', 'WorkflowCategory']} })
...
class WorkflowCategory(ConfiguredBaseModel):
    ...
    name: str = Field(default=..., description="""The display name of the workflow category.""", json_schema_extra = { "linkml_meta": {'alias': 'name', 'domain_of': ['Outbreak', 'WorkflowCategory']} })
