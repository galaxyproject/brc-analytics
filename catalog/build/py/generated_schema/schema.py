...
class WorkflowCategory(ConfiguredBaseModel):
    ...
    description: str = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "description", "domain_of": ["WorkflowCategory"]}
        },
    )
...
class Workflow(ConfiguredBaseModel):
    ...
    active: bool = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "active", "domain_of": ["Workflow"]}
        },
    )
...
class WorkflowUrlSpec(ConfiguredBaseModel):
    ...
    url: str = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "url", "domain_of": ["WorkflowUrlSpec"]}
        },
    )
