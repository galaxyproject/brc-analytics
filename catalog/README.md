...
- `ga2` - Catalog directory for Genome Ark 2, with contents laid out in an analogous manner to this one. See [README.md](./ga2/README.md) there for GA2-specific info.
