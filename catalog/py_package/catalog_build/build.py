    ...
    return pd.DataFrame(
        {
            ...
            # All non-scientific names NCBI knows for the taxon (name classes and
            # ordering set in the taxonomy_lineages_with_names dbt model).
            # Serialized as JSON because names may contain arbitrary characters
            # (including commas).
            "otherNames": assembly_taxonomy_df["other_names"].map(
