    ...
    return pd.DataFrame(
        {
            ...
            # Miscellaneous names for the taxon (including ancestors up to species level);
            # serialized as JSON because names may contain arbitrary characters (including commas).
