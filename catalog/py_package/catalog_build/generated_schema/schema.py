...
class WorkflowTargetPage(str, Enum):
    """
...
class WorkflowCategory(ConfiguredBaseModel):
    ...
    target_pages: Optional[List[WorkflowTargetPage]] = Field(default=None, description="""List of pages where workflows in this category should be available (e.g., assemblies page, organisms page).""", json_schema_extra = { "linkml_meta": {'alias': 'target_pages', 'domain_of': ['WorkflowCategory']} })
