...
class WorkflowCollectionSpec(ConfiguredBaseModel):
    ...
    collection_type: str = Field(default=..., description="""The type of Galaxy collection to create (e.g., 'list', 'list:paired'). Determines the structure of the collection.""", json_schema_extra = { "linkml_meta": {'alias': 'collection_type', 'domain_of': ['WorkflowCollectionSpec']} })
    elements: List[WorkflowUrlSpec] = Field(default=..., description="""Array of URL specifications that will become elements in the collection. Each element represents a file to include in the collection.""", json_schema_extra = { "linkml_meta": {'alias': 'elements', 'domain_of': ['WorkflowCollectionSpec']} })
    name: Optional[str] = Field(default=None, description="""Optional identifier for the collection, used as the collection name in Galaxy.""", json_schema_extra = { "linkml_meta": {'alias': 'name',
         'domain_of': ['Outbreak', 'WorkflowCategory', 'WorkflowCollectionSpec']} })
