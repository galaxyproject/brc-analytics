...
def load_catalog_source_data(
    *,
    ...
    DuckDB, along with the organisms' curated other names.
    ...
    Args:
      ...
      organisms_df: DataFrame of source organisms (must include `taxonomy_id` and `other_names` columns, the latter containing a list of curated other names or None per organism)
    ...
    organism_taxa_df = (
        organisms_df[["taxonomy_id", "other_names"]]
