import {
  MAX_FILE_SIZE_BYTES,
  VALIDATION_ERROR,
} from "@brc-analytics/core/components/ConfigureWorkflowInputs/components/Main/components/Stepper/components/Step/SequenceStep/hooks/UseFilePicker/constants";
