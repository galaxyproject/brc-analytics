      ...
      <Grid gridSx={{ gap: 4 }}>
        <Accordion>
          ...
          <AccordionDetails>
            ...
            2. Embedded Galaxy Pages (notebook-like documents containing workflow results) in relevant GenomeArk Analytics pages
            ...
            5. visualize downstream analysis items in GenomeArk Analytics, such as Pretext results
          </AccordionDetails>
        </Accordion>
        <Accordion>
          ...
          <AccordionDetails>
            ...
            1. Embed results of Galaxy analyses directly in the GenomeArk Analytics site for community reference
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            5. Embed a wide diversity of analysis results from Galaxy as essential context for research on supported organisms
