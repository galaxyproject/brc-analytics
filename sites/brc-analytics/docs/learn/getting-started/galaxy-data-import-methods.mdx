...
breadcrumbs:
  ...
  - path: ""
    text: "Getting Your Data into Galaxy"
contentType: "ARTICLE"
description: ""
enableOutline: true
...
![Select from ENA dialog box](/learn/select_from_ENA.png)
...
![Upload in Galaxy history message](/learn/upload_data_in_galaxy.png)
...
![Galaxy upload dialog](/learn/galaxy-upload-dialog.png)
...
![Galaxy "Get Data" tool set](/learn/galaxy-get-data-tools.png)
