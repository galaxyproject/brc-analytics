...
For detailed instructions on uploading and importing data into Galaxy, see [Getting Your Data into Galaxy](/learn/getting-started/galaxy-data-import-methods).
