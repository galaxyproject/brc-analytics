...
During the beta we also keep a copy of each exchange -- what you asked, what the assistant answered, and which catalog lookups it made -- so we can see where it helps and where it falls short. These records are kept for 90 days and then deleted. Only the maintainers can read them, they aren't published or shared, and nothing is recorded about you beyond your account if you're signed in. This is the same reason the point above matters: don't type anything into the assistant you wouldn't want kept.
